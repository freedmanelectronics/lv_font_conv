...
`
  ...
  parser.add_argument('--rotate', {
    ...
    type: 'int',
    default: 0,
    help: 'Rotate glyph pixels clockwise by specified degrees (only for --format lvgl with -o).'
  });
  ...
  // Validate rotate option
  if (args.rotate > 0) {
    if (args.format !== 'lvgl' || !args.output) {
      console.log('--rotate ignored: only valid with --format lvgl and -o output file');
      args.rotate = 0;
    }
  }
